...
<?php
    ...
    if ($_SESSION['role'] == 'admin'){
        $menuItems['Manage Users'] = "/admin/users.php";
    }
    if ($_SESSION['role'] == 'teacher' || $_SESSION['role'] == 'admin'){
        $menuItems['Manage Games'] = "/manage_games.php";
    }
    if (isset($_SESSION['id'])){
        $menuItems['Log Out'] = "/logout.php";
    }
    else{
        $menuItems['Log In'] = "/login.php";
    }
?>
<style>
    .active {
...
<div class="text-[#fc6e51] w-full font-bold text-[1.5rem] md:text-[3rem] px-3 md:px-8 py-[1rem] relative
  flex md:flex-col flex-row items-center md:justify-center justify-between relative">
    <a href="/index.php" class="grow text-left md:text-center truncate text-[#fc6e51]">
