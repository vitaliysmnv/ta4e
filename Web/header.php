...
<div class="text-[#fc6e51] w-full font-bold text-[1.5rem] md:text-[3rem] px-3 md:px-8 py-[1rem] relative
  flex md:flex-col flex-row items-center md:justify-center justify-between relative">
    <a href="<?php echo $_SESSION['rootpath'] . "/index.php" ?>"
        class="grow text-left md:text-center truncate text-[#fc6e51]">
    ...
    <div id="menu-list"
        class="left-0 md:hidden overflow-hidden py-0 z-[1] flex flex-col absolute bg-white w-full top-[100%] transition-all h-0">
        <?php
